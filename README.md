...
Este é um repositório para o desenvolvimento de habilidades gerais de JavaScript, treinar lógica de programação e criação de pequenos algoritmos.
...
Conseguir aplicar lógica de programação na prática utilizando o JavaScript é algo que um desenvolvedor faz diariamente ao decorrer da sua carreira.
